...
def main():
    ...
    writer.write_table()
    f.write("\n")
    status_emoji = {"PASS": "✅PASS", "FAIL": "❌FAIL", "SKIP": "🛑SKIP", "NOT RUN": "NOT RUN", "NOT SET": "❓NOT SET"}
    for suite in suites_with_tests:
        tests_in_suite = []
        for test in suite.tests:
            tests_in_suite.append([test.name, status_emoji.get(test.status, "unknown"), test.elapsed_time.total_seconds()])
